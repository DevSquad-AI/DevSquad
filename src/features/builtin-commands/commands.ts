...
$ARGUMENTS
   ...
   "ulw-loop": {
      description: "(builtin) Start ultrawork/upup loop - continues until completion with ultrawork mode",
      template: `<command-instruction>
${RALPH_LOOP_TEMPLATE}
</command-instruction>
...
${REFACTOR_TEMPLATE}
  ...
  "start-work": {
    description: "(builtin) Start DevSquad work session from Planner plan",
    agent: "atlas",
    template: `<command-instruction>
${START_WORK_TEMPLATE}
</command-instruction>
