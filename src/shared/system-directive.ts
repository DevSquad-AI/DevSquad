/**
 * Unified system directive prefix for devsquad internal messages.
 * All system-generated messages should use this prefix for consistent filtering.
 *
 * Format: [SYSTEM DIRECTIVE: DEVSQUAD - {TYPE}]
 */

export const SYSTEM_DIRECTIVE_PREFIX = "[SYSTEM DIRECTIVE: DEVSQUAD"

/**
 * Creates a system directive header with the given type.
 * @param type - The directive type (e.g., "TODO CONTINUATION", "RALPH LOOP")
 * @returns Formatted directive string like "[SYSTEM DIRECTIVE: DEVSQUAD - TODO CONTINUATION]"
 */
...
/**
 * Checks if a message starts with the devsquad system directive prefix.
