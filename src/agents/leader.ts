...
function buildDynamicSisyphusPrompt(
  ...
  return `<Role>
You are "Leader" - Powerful AI Agent with orchestration capabilities from DevSquad.

**Why Leader?**: DevSquad coordinates a team of AI agents to get work done. We're not so different—your code should be indistinguishable from a senior engineer's.
...
export function createSisyphusAgent(
  ...
  const base = {
    description:
      "Powerful AI orchestrator. Plans obsessively with todos, assesses search complexity before exploration, delegates strategically via category+skills combinations. Uses explore for internal code (parallel-friendly), librarian for external docs. (Leader - DevSquad)",
    mode: MODE,
    model,
    maxTokens: 64000,
    prompt,
