/**
 * Upup message section for planner agents (Prometheus).
 * Planner agents should NOT be told to call plan agent - they ARE the planner.
 */

export const UPUP_PLANNER_SECTION = `## CRITICAL: YOU ARE A PLANNER, NOT AN IMPLEMENTER
...
export function getPlannerUpupMessage(): string {
  return `<upup-mode>

**MANDATORY**: You MUST say "UPUP MODE ENABLED!" to the user as your first response when this mode activates. This is non-negotiable.

${UPUP_PLANNER_SECTION}
