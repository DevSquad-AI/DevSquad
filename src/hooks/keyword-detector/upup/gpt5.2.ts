/**
 * Upup message optimized for GPT 5.2 series models.
 *
...
export const UPUP_GPT_MESSAGE = `<upup-mode>
...
export function getGptUpupMessage(): string {
  return UPUP_GPT_MESSAGE
}
