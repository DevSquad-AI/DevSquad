/**
 * Default upup message optimized for Claude series models.
 *
 * Key characteristics:
...
export const UPUP_DEFAULT_MESSAGE = `<upup-mode>
...
export function getDefaultUpupMessage(): string {
  return UPUP_DEFAULT_MESSAGE
}
